  ...
  <div class="panel-body">
        <div class="row">
            <div class="col-xs-6 col-sm-6 col-md-6">               
                <p>
                    <?php
                        echo \yii\helpers\Html::a('<i class="fa fa-circle text-blue"></i> 1) จำนวนผู้ป่วย แผนกแผนไทย',
                                ['/hosxp/ttmreport/ttmreport']);
                    ?>
                </p>    
  ...
  <div class="panel-body">
        <div class="row">
            <div class="col-xs-6 col-sm-6 col-md-6">               
                <p>
                    <?php
                        echo \yii\helpers\Html::a('<i class="fa fa-circle text-blue"></i> 1) สรุปยอดมูลค่าการใช้ยา IPD',
                                ['/hosxp/phar/report03']);
                    ?>
                </p>    
